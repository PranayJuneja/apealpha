  ...
  return (
    <div className="border border-line-strong bg-ink p-7 text-white md:p-9">
      <div className="flex flex-wrap items-start justify-between gap-5 border-b border-white/20 pb-6">
        <div>
          <p className="eyebrow text-white/60">Final understanding</p>
        ...
        <div className="text-right">
          ...
          <p className="mt-1 text-xs text-white/60">interpretation confidence</p>
        </div>
      </div>
      ...
      <div className="mt-8 grid gap-8 md:grid-cols-2">
        <div>
          <p className="eyebrow text-white/50">What drives the read</p>
        ...
        <div>
          <p className="eyebrow text-white/50">What could break it</p>
          <ul className="mt-4 grid gap-3 pl-5 text-sm leading-6 text-white/85">
      ...
      <p className="mt-8 border-t border-white/20 pt-5 text-xs text-white/50">
        {isOpenAI ? `Interpreted by ${understanding.model}` : "Deterministic fallback"}. Evidence only;
        the stance remains rules-based.
      </p>
    </div>
  );
}
